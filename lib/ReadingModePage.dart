...
class _ReadingModePageState extends State<ReadingModePage> {
  ...
  void initState(){
    super.initState();
    readingSpeedController.text="90";
                ...
                children: <Widget>[
                  ...
                  child: Column(
                    children: [Padding(
                        ...
                        child:Text("Режим чтения", style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800,fontSize: 20),)),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                      GestureDetector(
                          ...
                          decoration:  BoxDecoration(
                            ...
                            border: Border.all(
                              color: readingMode=="1 строка"?Color.fromRGBO(43, 208, 49, 1):Colors.transparent,
                              width: 3,
                            ),
                          ),

                          child: Text("1 строка",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800,fontSize: 20),textAlign: TextAlign.center,),
                        )),
                       GestureDetector(
                           onTap: (){
                          ...
                          decoration:  BoxDecoration(
                            ...
                            borderRadius: BorderRadius.only(
                                ...
                                bottomLeft: Radius.circular(5)),
                            border: Border.all(
                              color: readingMode=="2 строки"?Color.fromRGBO(43, 208, 49, 1):Colors.transparent,
                              width: 3,
                            ),
                          ),

                          child: Text("2 строки",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w800,fontSize: 20),textAlign: TextAlign.center,),
                        ))
                  ...
                  GestureDetector(
                      onTap: (){
                        ...
                        Navigator.of(context).push(PageRouteBuilder(
                          opaque: false,
                          pageBuilder: (BuildContext context, _, __) => ReadingPage()));},
                      child:Container(
                        ...
                        child: Center(child:Text("Чтение", style: TextStyle(color: Colors.white, fontSize: 22,fontWeight: FontWeight.w800),)),
                      )),Spacer(flex: 1,)
